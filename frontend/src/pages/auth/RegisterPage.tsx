        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
              ...
              />
              {errors.email && (
                <p style={{ fontSize: 'var(--text-xs)', color: 'var(--color-error)', margin: 0 }}>{errors.email.message}</p>
              )}
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
              ...
              {errors.password && (
                <p style={{ fontSize: 'var(--text-xs)', color: 'var(--color-error)', margin: 0 }}>{errors.password.message}</p>
              )}
            </div>

            {/* Confirmar senha */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
              <label style={{ fontSize: 'var(--text-xs)', fontWeight: 500, color: 'var(--color-text)' }}>Confirmar senha</label>
              <input
                type="password"
              ...
              {errors.confirmPassword && (
                <p style={{ fontSize: 'var(--text-xs)', color: 'var(--color-error)', margin: 0 }}>{errors.confirmPassword.message}</p>
              )}
            </div>
