"""harden users/portfolios timestamps as not null

Revision ID: 20260807_users_portfolios_ts_nn
Revises: 20260807_drop_dup_rate_idx
"""
...
revision: str = "20260807_users_portfolios_ts_nn"
down_revision: str = "20260807_drop_dup_rate_idx"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_TABLES = ("users", "portfolios")
