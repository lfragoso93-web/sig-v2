...
@pytest.mark.parametrize(
    ...
    [
        ...
        Path("app/cli/run_proventos_sync.py"),
...
def test_cli_dedicada_de_proventos_nao_importa_materializador() -> None:
    source_path = (
        Path(__file__).parents[1] / "app/cli/run_proventos_sync.py"
    )
    tree = ast.parse(source_path.read_text(encoding="utf-8"))
